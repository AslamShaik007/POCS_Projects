...
class testimonial(models.Model):
    ...
    author_image = models.FileField(upload_to='images/', null=True, blank=True)
...
class all_settings(models.Model):
    ...
    opening_hours = models.CharField(max_length=2000, null=True, blank=True)
    email = models.CharField(max_length=50, null=True, blank=True)
    copyright = models.CharField(max_length=50, null=True, blank=True)
    footerareatext1 = models.CharField(max_length=50, null=True, blank=True)
    footerareatext2 = models.CharField(max_length=50, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class items(models.Model):
    ...
    display_order_for_special_item = models.IntegerField(default=0, null=True, blank=True)
...
class OrderDetails(models.Model):
    ...
    subitem_id = models.ManyToManyField(SubItems)
    quantity = models.IntegerField(null=True,blank=True)
    total_price = models.CharField(max_length = 256)
    special_instructions = models.CharField(max_length=256,null=True,blank=True)
...
class booking_details(models.Model):
    inserted_id = models.IntegerField(null=True, blank=True)
    ...
    item_name = models.CharField(max_length=50, null=True, blank=True)
    item_image = models.CharField(max_length=50, null=True, blank=True)
...
class booking_contact(models.Model):
    name        = models.CharField(max_length=50, null=True, blank=True)
    phone       = models.CharField(max_length=50, null=True, blank=True)
    email       = models.CharField(max_length=50, null=True, blank=True)
    message     = models.CharField(max_length=2000, null=True, blank=True)
...
class AddToCartItems(models.Model):
