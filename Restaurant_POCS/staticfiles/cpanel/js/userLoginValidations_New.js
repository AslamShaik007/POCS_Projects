...
// New code end here
    if(loginUser.value !== "" && logiPassword.value !== "") {
        ...
        rememberUser();
        encryptPass();
        document.querySelector("#userLoginForm").submit();
...
function encryptPass() {
    var pass=document.getElementById('userLoginPassword').value;
    var passhide=document.getElementById('loginpasshide').value;

    if(pass=="") {
        document.getElementById('err').innerHTML='Error:Password is missing';
        return false;
    } else {
        document.getElementById("passhide").value = document.getElementById("userLoginPassword").value;
        var hashPass = CryptoJS.MD5(pass);
        document.getElementById('userLoginPassword').value=passhide;
        return true;
    }
}
// New code end here
...
// New code start here
function encrypt() {
    var pass=document.getElementById('userForgotPassword').value;
    var confPass=document.getElementById('userForgotConfPassword').value;
    ...
    if(pass=="") {
        ...
        document.getElementById("passhide").value = document.getElementById("userForgotPassword").value;
        var hashPass = CryptoJS.MD5(pass);
        document.getElementById('userForgotPassword').value=passhide;

        document.getElementById("confPasshide").value = document.getElementById("userForgotConfPassword").value;
        var hashPass = CryptoJS.MD5(confPass);
        document.getElementById('userForgotConfPassword').value=confPasshide;
        return true;
    }
}
// New code end here
